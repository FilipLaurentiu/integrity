...
use cairo_verifier::{
    air::{
        ...
        traces::{TracesUnsentCommitment, TracesCommitment, TracesConfig, TracesDecommitment, TracesWitness},
        layouts::{
            LayoutTrait,
            recursive::{
                autogenerated::{eval_composition_polynomial_inner, eval_oods_polynomial_inner},
                global_values::{GlobalValues, InteractionElements, DInteractionElements, EcPoint},
                ...
                traces::{traces_commit, traces_decommit},
            },
        },
...
impl LayoutRecursive of LayoutTrait<InteractionElements, DInteractionElements> {
    ...
    fn traces_commit(
        ...
        traces_commit(ref channel, unsent_commitment, config)
    }
    ...
    fn verify_cairo0(self: @PublicInput) -> (felt252, felt252) {
        RecursivePublicInputImpl::verify_cairo0(self)
    }

    fn verify_cairo1(self: @PublicInput) -> (felt252, felt252) {
        RecursivePublicInputImpl::verify_cairo1(self)
    }
}
